    ...
    <section id="filosofia" className="relative py-24 bg-background">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-24">
          ...
          {/* Misión */}
          <div className="glass-card p-10 rounded-3xl border border-cyber-cyan/30 hover:border-cyber-cyan/60 transition-colors relative overflow-hidden group">
          ...
          {/* Visión */}
          <div className="glass-card p-10 rounded-3xl border border-blue-500/30 hover:border-blue-500/60 transition-colors relative overflow-hidden group">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* Pilar 1 */}
            <div className="glass-panel p-8 rounded-2xl hover:-translate-y-2 transition-transform duration-300 border border-white/5">
              <Briefcase className="w-10 h-10 text-cyber-cyan mb-6" />
              <h4 className="text-xl font-bold text-white mb-4">La Verdadera Libertad Empresarial</h4>
            ...
            {/* Pilar 2 */}
            <div className="glass-panel p-8 rounded-2xl hover:-translate-y-2 transition-transform duration-300 border border-white/5">
              <Heart className="w-10 h-10 text-cyber-red mb-6" />
              <h4 className="text-xl font-bold text-white mb-4">Calidad de Vida y Enfoque</h4>
              <p className="text-gray-400 leading-relaxed text-sm">
            ...
            <div className="glass-panel p-8 rounded-2xl hover:-translate-y-2 transition-transform duration-300 border border-white/5">
              ...
              <h4 className="text-xl font-bold text-white mb-4">Tecnología con Propósito</h4>
              <p className="text-gray-400 leading-relaxed text-sm">
            ...
            {/* Pilar 4 */}
            <div className="glass-panel p-8 rounded-2xl hover:-translate-y-2 transition-transform duration-300 border border-white/5 lg:col-span-1 md:col-span-2 lg:col-start-1 lg:translate-x-1/2">
              <Target className="w-10 h-10 text-cyber-cyan mb-6" />
              <h4 className="text-xl font-bold text-white mb-4">Eficiencia Absoluta</h4>
              <p className="text-gray-400 leading-relaxed text-sm">
            ...
            {/* Pilar 5 */}
            <div className="glass-panel p-8 rounded-2xl hover:-translate-y-2 transition-transform duration-300 border border-white/5 lg:col-span-1 md:col-span-2 lg:translate-x-1/2">
              <TrendingUp className="w-10 h-10 text-green-400 mb-6" />
              <h4 className="text-xl font-bold text-white mb-4">Impulso y Transformación Local</h4>
              <p className="text-gray-400 leading-relaxed text-sm">
